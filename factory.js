(function () {
  ...
  let SITE_ID = 'bartchat';
  let site = null;
  let COLORS = ['#101820', '#0099d8', '#0077a8', '#d32f2f', '#2a3d4a', '#4a5c68'];
  let TRENDS = [];
  let PLACES = [];
  let TOPICS = [];
  ...
  fetch(SITE_JSON_URL)
    ...
    .catch(function (e) {
      ...
      boot({ siteId: 'bartchat', name: 'bartchat', tagline: 'Nothing but BART.' });
    });
})();
